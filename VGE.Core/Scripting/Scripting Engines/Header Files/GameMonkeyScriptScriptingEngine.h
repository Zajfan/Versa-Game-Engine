#ifndef GAMEMONKEYSCRIPTSCRIPTINGENGINE_H
#define GAMEMONKEYSCRIPTSCRIPTINGENGINE_H

#include <string>
#include <any>
#include <vector>

class GameMonkeyScriptScriptingEngine
{
public:
    virtual ~GameMonkeyScriptScriptingEngine() = default;
...
#endif // GAMEMONKEYSCRIPTSCRIPTINGENGINE_H
