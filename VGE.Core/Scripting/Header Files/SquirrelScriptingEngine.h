#ifndef SQUIRRELSCRIPTINGENGINE_H
#define SQUIRRELSCRIPTINGENGINE_H

#include <string>
#include <any>
#include <vector>

class SquirrelScriptingEngine
{
public:
    virtual ~SquirrelScriptingEngine() = default;
...
#endif // SQUIRRELSCRIPTINGENGINE_H
