#ifndef ANGELSCRIPTSCRIPTINGENGINE_H
#define ANGELSCRIPTSCRIPTINGENGINE_H

#include <string>
#include <any>
#include <vector>

class AngelScriptScriptingEngine
{
public:
    virtual ~AngelScriptScriptingEngine() = default;
...
#endif // ANGELSCRIPTSCRIPTINGENGINE_H
