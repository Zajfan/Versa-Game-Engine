#ifndef WEBASSEMBLYSCRIPTINGENGINE_H
#define WEBASSEMBLYSCRIPTINGENGINE_H

#include <string>
#include <any>
#include <vector>

class WebAssemblyScriptingEngine
{
public:
    virtual ~WebAssemblyScriptingEngine() = default;
...
#endif // WEBASSEMBLYSCRIPTINGENGINE_H
