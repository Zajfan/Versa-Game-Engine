#ifndef JAVASCRIPTSCRIPTINGENGINE_H
#define JAVASCRIPTSCRIPTINGENGINE_H

#include <string>
#include <any>
#include <vector>

class JavaScriptScriptingEngine
{
public:
    virtual ~JavaScriptScriptingEngine() = default;
...
#endif // JAVASCRIPTSCRIPTINGENGINE_H
