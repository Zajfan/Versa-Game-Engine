#ifndef CSHARPSCRIPTINGENGINE_H
#define CSHARPSCRIPTINGENGINE_H

#include <string>
#include <any>
#include <vector>

class CSharpScriptingEngine
{
public:
    virtual ~CSharpScriptingEngine() = default;
